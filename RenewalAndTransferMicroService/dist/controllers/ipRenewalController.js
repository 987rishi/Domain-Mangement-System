...
exports.getIpRenewals = exports.getIpRenewal = exports.completeIpRenewal = exports.reviewIpRenewal = exports.rejectIpRenewal = exports.approveIpRenewal = exports.createIpRenewal = void 0;
...
// @access Private
const createIpRenewal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const renewalExists = yield prisma_1.default.ipRenewal.findFirst({
            where: {
                ip_id,
                status: { not: client_1.IpRenewalRequestStatus.RENEWED_BY_NETOPS },
            },
        });
        if (renewalExists) {
            console.error("RENEWAL FOR THE IP IS ALREADY IN THE RENEWAL PROCESS".red);
            res.status(403).json({
                message: "Renewal for the ip_id already exists. Another renewal cannot be created.",
            });
            return;
        }
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        const domainInfo = yield (0, workflowService_1.getDomainDetails)(dm_id);
        if (!domainInfo) {
            const e = new errors_1.AppError(`Domain with id(${dm_id}) not found.`);
            e.statusCode = 404;
            throw e;
        }
        console.log(`${domainInfo}`.red);
        const ipInfo = yield (0, workflowService_1.getIpDetailsById)(ip_id);
        if (!ipInfo) {
            const e = new errors_1.AppError(`IP with id(${ip_id}) not found.`);
            e.statusCode = 404;
            throw e;
        }
        console.log(`${ipInfo}`.red);
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        const rnwl_no = (yield prisma_1.default.ipRenewal.count({ where: { ip_id } })) + 1;
        const newRenewal = yield prisma_1.default.ipRenewal.create({
            data: {
                dm_id,
                ip_id,
                aprvl_pdf,
...
exports.createIpRenewal = createIpRenewal;
// @desc Approves a pending ip renewal request
// @route POST /api/renwals/ip/:ipRnwlId/approve
// @access Private
const approveIpRenewal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const renewal = yield prisma_1.default.ipRenewal.findUnique({
            where: { ip_rnwl_id },
        });
        if (!renewal) {
        ...
        if (renewal.status !== client_1.IpRenewalRequestStatus.PENDING_APPROVAL) {
            console.error(`Requests already been approved`.red);
            res.status(403).json({
        ...
        const approvedRenewal = yield prisma_1.default.ipRenewal.update({
            where: {
                ip_rnwl_id,
            },
            data: {
                ...
                hod_remarks,
                status: client_1.IpRenewalRequestStatus.APPROVED_BY_HOD,
            },
        });
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        // await sendNotification(
...
exports.approveIpRenewal = approveIpRenewal;
// @desc Rejects a pending ip renewal
// @route POST /api/renwals/ip/:ipRnwlId/reject
// @access Private
const rejectIpRenewal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const ip_rnwl_id = parseInt(req.params.ipRnwlId);
    ...
    try {
        ...
        const rejectedRenewal = yield prisma_1.default.ipRenewal.update({
            where: {
                ip_rnwl_id,
            },
            data: {
                ...
                approved_at: new Date(),
                hod_remarks,
                status: client_1.IpRenewalRequestStatus.REJECTED_BY_HOD,
            },
        });
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        // await sendNotification(
...
exports.rejectIpRenewal = rejectIpRenewal;
...
const reviewIpRenewal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (renewal.status !== client_1.IpRenewalRequestStatus.REJECTED_BY_HOD) {
            console.error("".red);
            res.status(403).json({
                message: "A renewal request in this stage of the renewal process cannot be reviewed",
            });
            return;
        }
        const reviewedRenewal = yield prisma_1.default.ipRenewal.update({
            where: { ip_rnwl_id },
            data: {
                aprvl_pdf,
                drm_remarks: drm_remarks ? drm_remarks : "NA",
                created_at: new Date(),
                status: client_1.IpRenewalRequestStatus.PENDING_APPROVAL,
            },
        });
        if (!reviewedRenewal) {
...
exports.reviewIpRenewal = reviewIpRenewal;
// @desc Completes a ip renewal
// @route POST /api/renwals/ip/:ipRnwlId/complete
// @access Private
const completeIpRenewal = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const netops_empno = req.user.empno || BigInt(1);
    const ip_rnwl_id = parseInt(req.params.ipRnwlId);
    const { dm_id, new_ip_addrs, ip_expiry_date, rnwl_pdf, netops_remarks } = req.body;
    // Check the fields and their types
    ...
    try {
        ...
        if (renewal.status !== client_1.IpRenewalRequestStatus.APPROVED_BY_HOD) {
            console.error("RENEWAL FOR THE ip IS ALREADY IN THE RENEWAL PROCESS".red);
            res.status(403).json({
        ...
        const completedRenewal = yield prisma_1.default.ipRenewal.update({
            where: { ip_rnwl_id },
            data: {
                is_rnwd: true,
                rnwl_pdf,
                ...
                renewed_at: new Date(),
                status: client_1.IpRenewalRequestStatus.RENEWED_BY_NETOPS,
            },
        });
        if (!completedRenewal) {
...
exports.completeIpRenewal = completeIpRenewal;
const getIpRenewal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // const drm_empno = req.user.empno;
    const ip_rnwl_id = parseInt(req.params.ipRnwlId);
    try {
        const renewal = yield prisma_1.default.ipRenewal.findMany({ where: { ip_rnwl_id } });
        if (!renewal)
...
exports.getIpRenewal = getIpRenewal;
const getIpRenewals = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // const drm_empno = req.user.empno;
    try {
        const renewals = yield prisma_1.default.ipRenewal.findMany();
...
exports.getIpRenewals = getIpRenewals;
