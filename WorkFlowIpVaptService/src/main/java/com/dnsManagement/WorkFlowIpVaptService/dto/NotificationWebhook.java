...
public class NotificationWebhook {
    ...
    public enum EventType {
        ...
        DOMAIN_RENEWAL_ARM_FORWARDED,
        DOMAIN_RENEWAL_HOD_VERIFIED,
        DOMAIN_RENEWAL_ED_APPROVED,
        DOMAIN_RENEWAL_NETOPS_VERIFIED,
        DOMAIN_RENEWAL_WEBMASTER_VERIFIED,
        DOMAIN_RENEWAL_HPC_HOD_RECOMMENDED,
